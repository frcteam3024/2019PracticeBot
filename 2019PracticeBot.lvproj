...
AddOutputFilter chunkFilter
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Swerve" Type="Folder">
				<Item Name="SwerveMain.vi" Type="VI" URL="../Swerve/SwerveMain.vi"/>
				<Item Name="CalcTheta.vi" Type="VI" URL="../Swerve/CalcTheta.vi"/>
				<Item Name="CalcStrafeAngles.vi" Type="VI" URL="../Swerve/CalcStrafeAngles.vi"/>
				<Item Name="DeadbandJoystick.vi" Type="VI" URL="../Swerve/DeadbandJoystick.vi"/>
				<Item Name="FlipAngleFunction.vi" Type="VI" URL="../Swerve/FlipAngleFunction.vi"/>
				<Item Name="FindAngleDifference.vi" Type="VI" URL="../Swerve/FindAngleDifference.vi"/>
				<Item Name="CalcRotationAngles.vi" Type="VI" URL="../Swerve/CalcRotationAngles.vi"/>
				<Item Name="ResetAngleWithOffsetFunction.vi" Type="VI" URL="../Swerve/ResetAngleWithOffsetFunction.vi"/>
				<Item Name="Rotate Vector.vi" Type="VI" URL="../Swerve/Rotate Vector.vi"/>
				<Item Name="SwerveAngleEncoderConversion.vi" Type="VI" URL="../Swerve/SwerveAngleEncoderConversion.vi"/>
				<Item Name="SwerveDriveLogic.vi" Type="VI" URL="../Swerve/SwerveDriveLogic.vi"/>
				<Item Name="SwerveJoystickLogic.vi" Type="VI" URL="../Swerve/SwerveJoystickLogic.vi"/>
				<Item Name="SwerveShortestTurnAlg.vi" Type="VI" URL="../Swerve/SwerveShortestTurnAlg.vi"/>
				<Item Name="SwerveGlobals.vi" Type="VI" URL="../Swerve/SwerveGlobals.vi"/>
				<Item Name="VisionAlign.vi" Type="VI" URL="../VisionAlign.vi"/>
			</Item>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="ClimbLogic.vi" Type="VI" URL="../ClimbLogic.vi"/>
			<Item Name="Disabled.vi" Type="VI" URL="../Disabled.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Global Data.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="TeleopControls.vi" Type="VI" URL="../TeleopControls.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="AutoTrackRobot.vi" Type="VI" URL="../AutoTrackRobot.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="Round.vi" Type="VI" URL="../Swerve/Round.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
